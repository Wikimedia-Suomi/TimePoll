...
PIP_AUDIT_BIN=${PIP_AUDIT_BIN:-"$VENV_DIR/bin/pip-audit"}
...
COVERAGE_FAIL_UNDER=${COVERAGE_FAIL_UNDER:-87}

export REPO_ROOT VENV_DIR PYTHON_BIN PIP_BIN PIP_AUDIT_BIN
export TIMEPOLL_SECRET_KEY TIMEPOLL_DEBUG TIMEPOLL_ALLOWED_HOSTS
export PLAYWRIGHT_BROWSERS_PATH PLAYWRIGHT_INSTALL_ARGS PIP_AUDIT_IGNORE PIP_AUDIT_CACHE_DIR COVERAGE_FAIL_UNDER
