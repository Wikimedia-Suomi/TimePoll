...
urlpatterns = [
    ...
    path("api/polls/<str:poll_ref>/", views.poll_detail, name="poll_detail"),
    path("api/polls/<str:poll_ref>/close/", views.poll_close, name="poll_close"),
    path("api/polls/<str:poll_ref>/reopen/", views.poll_reopen, name="poll_reopen"),
    path("api/polls/<str:poll_ref>/votes/", views.poll_votes_upsert, name="poll_votes_upsert"),
    path(
        "api/polls/<str:poll_ref>/votes/<int:option_id>/",
